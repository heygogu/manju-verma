...
const getTestimonials = async () => {
    try {
      const apiRes=await axios.get('/api/testimonials')
      return apiRes?.data
    } catch (error) { 
...
useEffect(() => {
  const fetchAllData = async () => {
    try {
      const [blogsRes, websitesRes, emailsRes,testimonialRes] = await Promise.all([
      ...
      {loading ? (
        ...
        <>
          ...
          <main>
            ...
            <section
              id="about"
              className="py-20  px-6 md:px-15 lg:px-55  relative"
            >
                ...
                <div className="grid gap-12 md:grid-cols-2 items-center">
                  ...
                  >
                    ...
                    <p className="text-[#ffffffcc] ">
                      ...
                      turning ideas into stories that connect, inspire, and
                      engage. With over two years of experience in content
                      writing, I’ve worked both full-time and as a freelancer
                      across various industries, helping brands find their voice
                      and connect with their audience through compelling
                      storytelling and{" "}
                      <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#FF00FF] to-[#00FFFF]">
                        SEO-optimized
                      </span>{" "}
                    ...
                    <p className="text-[#ffffffcc] ">
                      ...
                      worked with startups and established brands alike,
                      creating content that not only ranks but truly
                      <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#FF00FF] to-[#00FFFF]">
                        {" "}
                    ...
                    <div className="grid grid-cols-2 gap-4 mt-4">
                      {[
                        ...
                        {
                          icon: (
                            <Clipboard className="h-5 w-5 text-[#00FFFF]" />
                          ),
                          label: "Copywriting ",
                        },
                      ].map((item, i) => (
                  ...
                  <TabsContent value="websites" className="mt-0 ">
                    <div className="grid gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-3">
                      {websiteListing?.data?.length
                        ? websiteListing?.data?.map(
                            (website: any, i: number) => (
                              <WebsiteCard
                                key={i}
                                website={website}
                                index={i}
            ...
            {/* Testimonials Section */}
           {
            ...
            <section
              id="testimonials"
              className=" py-20 px-6 md:px-15 lg:px-55"
            >
              <div className="container mx-auto">
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                ...
                >
                  ...
                  <div className="grid gap-6 md:grid-cols-2 items-center relative z-10">
                    <div className="flex flex-col gap-4">
                      ...
                      <p className="text-md md:text-lg text-[#ffffffcc] ">
                        Let&apos;s work together to create content that engages
              ...
              <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                <div className="space-y-4 z-10">
                  ...
                  <p className="text-[#ffffffcc] text-md ">
                    Professional content writer helping brands tell their
